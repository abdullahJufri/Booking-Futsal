...
class DiffCallback2(
    private val mOldFavList: List<SpinnerItems>,
    private val mNewFavList: List<SpinnerItems>
) : DiffUtil.Callback() {
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int) =
        mOldFavList[oldItemPosition].value == mNewFavList[newItemPosition].value

    override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        val oldEmployee = mOldFavList[oldItemPosition]
        val newEmployee = mNewFavList[newItemPosition]
        return oldEmployee.value == newEmployee.value
    }
}